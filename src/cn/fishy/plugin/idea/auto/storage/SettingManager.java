...
public class SettingManager {
    ...
    public static void applyPrj(Setting setting) {
        PluginProjectConfig pluginProjectConfig = PluginProjectConfigHolder.getPluginProjectConfig();
        if (pluginProjectConfig != null) {
            if (setting.getEncoding() != null) {
                pluginProjectConfig.encoding = setting.getEncoding();
            }
            if (setting.getCode() != null) {
                pluginProjectConfig.code = setting.getCode();
            }
            if (setting.getPath() != null) {
                pluginProjectConfig.path = setting.getPath();
            }
            if (setting.isManagerUseBO() != null) {
                pluginProjectConfig.managerUseBO = setting.isManagerUseBO();
            }
            if (setting.isDaoLogicDelete() != null) {
                pluginProjectConfig.daoLogicDelete = setting.isDaoLogicDelete();
            }
            if (setting.isDaoUseSequence() != null) {
                pluginProjectConfig.daoUseSequence = setting.isDaoUseSequence();
            }
            if (setting.isPagerQuery() != null) {
                pluginProjectConfig.pagerQuery = setting.isPagerQuery();
            }
            if (setting.isOverwrite() != null) {
                pluginProjectConfig.overwrite = setting.isOverwrite();
            }
            if (setting.isGenerateBase() != null) {
                pluginProjectConfig.generateBase = setting.isGenerateBase();
            }
        }
    }
    ...
    public static void applySwitch(Boolean managerUseBO, Boolean daoLogicDelete, Boolean daoUseSequence, Boolean pagerQuery, Boolean overwrite, Boolean generateBase) {
        PluginProjectConfig pluginProjectConfig = PluginProjectConfigHolder.getPluginProjectConfig();
        if (pluginProjectConfig != null) {
            if (managerUseBO != null) {
                pluginProjectConfig.managerUseBO = managerUseBO;
            }
            if (daoLogicDelete != null) {
                pluginProjectConfig.daoLogicDelete = daoLogicDelete;
            }
            if (daoUseSequence != null) {
                pluginProjectConfig.daoUseSequence = daoUseSequence;
            }
            if (pagerQuery != null) {
                pluginProjectConfig.pagerQuery = pagerQuery;
            }
            if (overwrite != null) {
                pluginProjectConfig.overwrite = overwrite;
            }
            if (generateBase != null) {
                pluginProjectConfig.generateBase = generateBase;
            }
        }
    }
