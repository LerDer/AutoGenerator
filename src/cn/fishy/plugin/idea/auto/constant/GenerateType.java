...
public enum GenerateType {
    DO("DO","","dal/dataobject/","dal.dataobject",TypePath.SRC),
    BO("BO","BO","bo/","bo",TypePath.SRC),
    Query("Query","Query","dal/query/","dal.query",TypePath.SRC),
    SQLMap("SQLMap","Mapper","dal/sqlmap/","dal.dataobject",TypePath.RESOURCES),
    DAO("DAO","Mapper","dal/dao/","dal.dao",TypePath.SRC),
